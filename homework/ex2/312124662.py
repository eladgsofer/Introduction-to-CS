...
class GameOfLife(game_of_life_interface.GameOfLife):
    ...
    def __init__(self, size_of_board, starting_position=1, rules='B3/S23'):
        self.size_of_board = size_of_board
        self.nxn = tuple([self.size_of_board] * 2)
        self.frame_nxn = tuple([self.size_of_board + 2] * 2)
    ...
    def neighbors_calc(self):
        ...
        for r_offset, c_offset in self.offset:
            ...
            shifted_board[r_offset:r_offset + self.size_of_board,
            c_offset:c_offset + self.size_of_board] = self.board
    ...
    def return_board(self):
        ''' This method returns a list of the board head_position. The board is a two-dimensional list that every
